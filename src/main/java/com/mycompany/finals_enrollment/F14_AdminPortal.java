 ...
 * @author aname
 */
public class F14_AdminPortal extends javax.swing.JFrame {

    /**
     * Creates new form F14_AdminPortal
     */
    public F14_AdminPortal() {
        initComponents();
    ...
    private void admin_exitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_admin_exitActionPerformed
       Finals_enrollment.previousFrame=("AdminPortalExit");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F14_AdminPortal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
